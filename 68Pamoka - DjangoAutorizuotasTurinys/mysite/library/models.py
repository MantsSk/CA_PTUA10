...
class Book(models.Model):
    ...
    cover_image = models.ImageField('Cover image', upload_to='book_covers', null=True, blank=True)
...
class BookInstance(models.Model):
    ...
    reader = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL)
